...
<?php
    ...
    define("merchantMid", "aLBSKa43047815563572");
    // Key in your staging and production MID available in your dashboard
    define("merchantKey", "wfJsS!PHjICZuXSC");
    // Key in your staging and production merchant key available in your dashboard
    define("orderId", "order1001");
    define("channelId", "WEB");
    define("custId", "c1001");
    define("mobileNo", 7208948014);
    define("email", "info@crceformularacing.com");
    define("txnAmount", "500.12");
    define("website", "WEBSTAGING");
    // This is the staging value. Production value is available in your dashboard
    define("industryTypeId", "Retail");
    // This is the staging value. Production value is available in your dashboard
    define("callbackUrl", "https://crceformularacing.com/success.html");
    $paytmParams = array();
